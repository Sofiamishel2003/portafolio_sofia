      ...
      <div className="section">
        ...
        <div className="projects">
          <div className="project-card">
              <img src="public/Blog.png" alt="Cetacean Blog" />
              <h4>Cetacean Blog</h4>
            ...
            <div className="project-card">
              <img src="public/calculadora.png" alt="Calculator" />
              <h4>Calculator</h4>
            ...
            <div className="project-card">
              <img src="public/Tablau.png" alt="BI Dashboard" />
              <h4>BI Dashboard</h4>
            ...
            <div className="project-card">
              <img src="public/cetaceansApi.png" alt="Cetacean API" />
              <h4>Cetacean API</h4>
